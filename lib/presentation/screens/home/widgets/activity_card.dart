        ...
        child: Row(
          children: [
            ...
            Container(
              ...
              child: Icon(
                _iconForCategory(widget.activity.category.target?.name ?? 'Unknown'),
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    '${widget.activity.category.target?.name ?? 'Unknown'} · ${widget.activity.durationMinutes.minutesToLabel}',
            ...
            // Points earned
            Text(
              '${widget.activity.points >= 0 ? '+' : ''}${widget.activity.points.toStringAsFixed(0)}',
              style: AppText.displaySmall.copyWith(
                fontSize: 20,
                color: widget.activity.points >= 0 ? AppColors.success : AppColors.error,
              ),
            ),
          ],
        ),
