...
class _TemplateCardState extends State<TemplateCard> {
  ...
  Color get _categoryColor => AppColors.rewardColorForCategory(widget.template.category);

  String get _recurrenceLabel {
    return switch (widget.template.recurrenceType) {
      RecurrenceType.recurring =>
        '🔄 Tiap ${widget.template.recurrenceIntervalDays ?? 7} hari',
      RecurrenceType.limited =>
        '📅 Maks ${widget.template.monthlyLimit ?? 1}x/bulan',
      _ => '',
    };
  }
  ...
  Widget build(BuildContext context) {
    final isClickable = !widget.isAdded;
